...
public class MensturalApp{
	...
	public static void main(String[] args){
		...
		LocalDate fertilePeriodstart = ovulationPeriod.minusDays(2);
		System.out.println("Your most fertile period start: " + fertilePeriodstart);

		LocalDate fertilePeriodend = ovulationPeriodEnd.plusDays(1);

		System.out.println("Your most fertile period end: " + fertilePeriodend);
